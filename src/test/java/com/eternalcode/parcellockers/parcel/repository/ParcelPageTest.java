...
class ParcelPageTest {
    ...
    void previousWhenCurrentPageIsFirstThenThrowException() {
        ParcelPage parcelPage = new ParcelPage(0, 10);
    ...
    void previousWhenCurrentPageIsNotFirst() {
        ParcelPage parcelPage = new ParcelPage(2, 10);
        ParcelPage previousPage = parcelPage.previous();
    ...
    void hasPreviousWhenPageNumberIsGreaterThanZero() {
        ParcelPage parcelPage = new ParcelPage(1, 10);
