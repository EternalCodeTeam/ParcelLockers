...
public record Parcel(UUID uuid, UUID sender, String name, String description, boolean priority, Set<UUID> recipients,
                     UUID receiver, ParcelSize size, UUID entryLocker, UUID destinationLocker) {
